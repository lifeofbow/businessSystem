...
<div class="block-content">
	<ul class="nav nav-tabs" >
	  ...
	  <li ><a href="{{ URL::to('config/translation') }}" >  {{ Lang::get('core.tab_translation'); }} </a></li>
...
<div class="tab-content m-t">
  ...
  <div class="sbox-content"> 
		...
		<div class="col-sm-6 animated fadeInRight ">
		  ...
		  <div class="form-group">
		    <label for="ipt" class=" control-label col-md-4"> {{ Lang::get('core.fr_multilanguage'); }} </small> </label>
			<div class="col-md-8">
				<div class="checkbox">
		  ...
		  <div class="form-group">
		    <label for="ipt" class=" control-label col-md-4"> {{ Lang::get('core.fr_appmode'); }}  </label>
			<div class="col-md-8">
				<div class="checkbox">
